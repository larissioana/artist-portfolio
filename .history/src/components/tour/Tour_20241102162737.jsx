                        ...
                        <tbody>
                            {
                                tour.map((event) => (
                                    <tr key={event.id}>
                                        <td style={{ borderBottom: '1px solid white', padding: '10px', fontSize: "1.1REM" }}>
                                            <div style={{
                                        ...
                                        <td style={{ borderBottom: '1px solid white', padding: '10px', border: "1px solid white" }}>{event.ticket}</td>
                                    </tr>
                                ))}
                        </tbody>
                    </table>
