            ...
            <div className="tour-container">
                ...
                <div style={{ overflowX: 'auto' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                            <tr>
                                <th style={{ border: '1px solid black', padding: '10px' }}>Date & Location</th>
                                <th style={{ border: '1px solid black', padding: '10px' }}>City</th>
                                <th style={{ border: '1px solid black', padding: '10px' }}>Tickets</th>
                            </tr>
                        </thead>
                        <tbody>
                            {tour.map((event) => (
                                <tr key={event.id}>
                                    ...
                                    <td style={{ border: '1px solid black', padding: '10px' }}>{event.city}</td>
                                    <td style={{ border: '1px solid black', padding: '10px' }}>{event.ticket}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
