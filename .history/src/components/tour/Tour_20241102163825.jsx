                        ...
                        <tbody>
                            {
                                tour.map((event) => (
                                    <tr key={event.id}>
                                        <td style={{ borderBottom: '1px solid black', padding: '1rem', fontSize: "1.1rem", fontWeight: "bolder!important" }}>
                                            <div style={{
                                                textTransform: "uppercase"
                                            }}>{event.date}</div>
                                            <div>{event.location}</div>
                                        </td>
                                        <td style={{ borderBottom: '1px solid black', padding: '10px' }}>{event.city}</td>
                                        <td className="ticket" style={{ borderBottom: '1px solid black', padding: '10px', textTransform: "uppercase" }}>{event.ticket}</td>
                                    </tr>
                                ))}
                        </tbody>
                    </table>
