                        ...
                        <tbody>
                            {
                                tour.map((event) => (
                                    <tr key={event.id}>
                                        <td style={{ borderBottom: '1px solid black', padding: '15px', fontSize: "1.1REM" }}>
                                            <div style={{
                                        ...
                                        <td style={{ borderBottom: '1px solid black', padding: '10px', textTransform: "uppercase" }}>{event.ticket}</td>
                                    </tr>
                                ))}
                        </tbody>
                    </table>
